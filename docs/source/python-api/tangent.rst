...
.. autofunction:: ipctk.point_edge_closest_point
.. autofunction:: ipctk.edge_edge_closest_point
.. autofunction:: ipctk.point_triangle_closest_point


Closet Points Jacobians
^^^^^^^^^^^^^^^^^^^^^^^

.. autofunction:: ipctk.point_edge_closest_point_jacobian
.. autofunction:: ipctk.edge_edge_closest_point_jacobian
.. autofunction:: ipctk.point_triangle_closest_point_jacobian