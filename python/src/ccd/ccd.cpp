...
void define_ccd(py::module_& m)
{
    ...
    //     },
    //     R"ipc_Qu8mg5v7(
    //     Computes the time of impact between two points using continuous
    //     collision detection.
    ...
    //         conservative_rescaling: The conservative rescaling of the time of
    //         impact.
    ...
    //     py::arg("p1_t1"), py::arg("min_distance") = 0.0, py::arg("tmax")
    //     = 1.0, py::arg("tolerance") = DEFAULT_CCD_TOLERANCE,
    ...
    //     },
    //     R"ipc_Qu8mg5v7(
    //     Computes the time of impact between a point and an edge using
    ...
    //             eb1_t1, toi, min_distance, tmax, tolerance, max_iterations,
    //             conservative_rescaling);
    //         return std::make_tuple(r, toi);
    //     },
    //     R"ipc_Qu8mg5v7(
    //     Computes the time of impact between two edges in 3D using continuous
    //     collision detection.

    //     Parameters:
    //         ea0_t0: The initial position of the first endpoint of the first
    //         edge. ea1_t0: The initial position of the second endpoint of the
    //         first edge. eb0_t0: The initial position of the first endpoint of
    //         the second edge. eb1_t0: The initial position of the second
    //         endpoint of the second edge. ea0_t1: The final position of the
    //         first endpoint of the first edge. ea1_t1: The final position of
    //         the second endpoint of the first edge. eb0_t1: The final position
    //         of the first endpoint of the second edge. eb1_t1: The final
    //         position of the second endpoint of the second edge. min_distance:
    //         The minimum distance between the objects. tmax: The maximum time
    //         to check for collisions. tolerance: The error tolerance for the
    //         time of impact. max_iterations: The maximum number of iterations
    //         to perform. conservative_rescaling: The conservative rescaling of
    //         the time of impact.
    ...
    //     },
    //     R"ipc_Qu8mg5v7(
    //     Computes the time of impact between a point and a triangle in 3D
    ...
    //        const double initial_distance, const double
    //        conservative_rescaling) {
    //         double toi;
    //         bool r = ccd_strategy(
    ...
    //     },
    //     R"ipc_Qu8mg5v7(
    //     Helper function to check if the initial distance is less than the
    //     minimum distance.
    ...
    //     Returns:
    //         Tuple of:
    //         True if the initial distance is less than the minimum distance,
    //         false otherwise. Set to 0 if the initial distance is less than
