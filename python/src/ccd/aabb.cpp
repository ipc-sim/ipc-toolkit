...
void define_ccd_aabb(py::module_& m)
{
    m.def(
        ...
        py::arg("e0"), py::arg("e1"), py::arg("dist"));

    m.def(
        "edge_edge_aabb_cd", &edge_edge_aabb_cd, "", py::arg("ea0"),
        py::arg("ea1"), py::arg("eb0"), py::arg("eb1"), py::arg("dist"));
    ...
    m.def(
        "point_triangle_aabb_ccd", &point_triangle_aabb_ccd, "",
