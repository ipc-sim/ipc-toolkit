...
void define_smooth_mu(py::module_& m)
{
    ...
    m.def(
        "smooth_mu_derivative", &smooth_mu_derivative<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        "smooth_mu_f0", &smooth_mu_f0<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        "smooth_mu_f1", &smooth_mu_f1<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        "smooth_mu_f2", &smooth_mu_f2<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        "smooth_mu_f1_over_x", &smooth_mu_f1_over_x<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        ...
        &smooth_mu_f2_x_minus_mu_f1_over_x3<double>,
        R"ipc_Qu8mg5v7(
