...
{
    m.def(
        "point_line_distance", &point_line_distance<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        "point_line_distance_gradient", &point_line_distance_gradient<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        "point_line_distance_hessian", &point_line_distance_hessian<double>,
        R"ipc_Qu8mg5v7(
