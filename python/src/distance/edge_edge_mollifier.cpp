...
{
    m.def(
        "edge_edge_cross_squarednorm", &edge_edge_cross_squarednorm<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        ...
        &edge_edge_cross_squarednorm_gradient<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        ...
        &edge_edge_cross_squarednorm_hessian<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        ...
        &edge_edge_mollifier_gradient_wrt_x<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        ...
        &edge_edge_mollifier_gradient_jacobian_wrt_x<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        "edge_edge_mollifier_threshold", &edge_edge_mollifier_threshold<double>,
        R"ipc_Qu8mg5v7(
    ...
    m.def(
        ...
        &edge_edge_mollifier_threshold_gradient<double>,
        R"ipc_Qu8mg5v7(
