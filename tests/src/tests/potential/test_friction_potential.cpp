...
//     epsv_times_h, dhat, barrier_stiffness, pairwise_friction] = data;
...
//     FrictionCollisions friction_collisions;
//     friction_collisions.build(mesh, V0, collisions, BarrierPotential(dhat),
//     barrier_stiffness, static_mu, kinetic_mu, pairwise_friction);

//     const FrictionPotential D(epsv_times_h);

//     // Compute the pairwise friction Hessian using the analytical method
//     const MatrixMax12d hess = D.pairwise_hessian(friction_collisions, V1,
//     FrictionPotential::PSDProjectionMethod::NONE, static_mu, kinetic_mu);

//     // Check Hessian with finite differences
//     auto f = [&](const Eigen::VectorXd& x) {
//         const Eigen::MatrixXd fd_U = fd::unflatten(x, data.V1.cols()) -
//         data.V0; return D.pairwise_hessian(friction_collisions, fd_U,
//         FrictionPotential::PSDProjectionMethod::NONE, static_mu, kinetic_mu);
//     };
