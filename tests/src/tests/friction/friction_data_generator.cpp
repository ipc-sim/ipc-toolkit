...
SmoothFrictionData smooth_friction_data_generator_3d()
{
    ...
    SECTION("edge-edge")
    {
        ...
        F.resize(12, 3);
        F << 1, 0, 4, 1, 5, 0, 1, 4, 8, 4, 0, 8, 0, 5, 8, 5, 1, 8, 2, 7, 3, 2,
            3, 6, 2, 6, 9, 6, 3, 9, 3, 7, 9, 7, 2, 9;
    ...
    SECTION("point-edge")
    {
        ...
        V0 << 0, d, 0, // point at t=0
            ...
            -1, d * 2, 1, 2, d * 2, 0, -1, d * 2, -1, 1, 0, 0, -1, 0, 0, 0, -d,
            0;
        ...
        F.resize(10, 3);
        F << 3, 0, 4, 4, 0, 5, 5, 0, 3, 3, 4, 5, 1, 7, 2, 1, 2, 6, 2, 7, 8, 7,
            1, 8, 1, 6, 8, 6, 2, 8;
    ...
    SECTION("point-point")
    {
        ...
        V0 << 0, 0, 0, 0, d, 0, -1, -d, 1, 2, -d, 0, -1, -d, -1, -1, 2 * d, 1,
            2, 2 * d, 0, -1, 2 * d, -1;
        ...
        F.resize(8, 3);
        F << 0, 2, 3, 0, 3, 4, 0, 4, 2, 3, 2, 4, 1, 6, 5, 1, 5, 7, 1, 7, 6, 5,
            6, 7;
        igl::edges(F, E);
...
SmoothFrictionData smooth_friction_data_generator_2d()
{
    ...
    {
        V0.resize(6, 2);
        V0 << d, 0, 0, 0, 1 + d, -1, 1 + d, 1, 0, -1, 0, 1;
