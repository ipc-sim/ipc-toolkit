...
namespace ipc {
        ...
        const ParameterType &params) const
    {
        ...
        if constexpr (!std::is_same<PrimitiveA, Edge3>::value || !std::is_same<PrimitiveB, Edge3>::value) {
            ...
            mollifier_hess.topLeftCorner(12, 12) += dist_sqr_AD.getHessian().topLeftCorner(12, 12) * mollifier_grad(12) + 
                dist_sqr_AD.getGradient() * mollifier_hess(12, 12) * dist_sqr_AD.getGradient().transpose() + 
