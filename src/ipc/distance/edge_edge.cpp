    ...
    EdgeEdgeDistanceType dtype)
{
    ...
    default:
        assert(false && "Invalid distance type for edge-edge distance!");
    ...
    EdgeEdgeDistanceType dtype)
{
    ...
    default:
        assert(false && "Invalid distance type for edge-edge gradient!");
    ...
    EdgeEdgeDistanceType dtype)
{
    ...
    default:
        assert(false && "Invalid distance type for edge-edge hessian!");
