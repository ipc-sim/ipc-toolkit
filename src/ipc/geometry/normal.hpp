...
IPC_TOOLKIT_HOST_DEVICE inline MatrixMax3d
normalization_jacobian(Eigen::ConstRef<VectorMax3d> x)
{
...
IPC_TOOLKIT_HOST_DEVICE inline std::array<MatrixMax3d, 3>
...
IPC_TOOLKIT_HOST_DEVICE inline Eigen::Matrix3d
cross_product_matrix(Eigen::ConstRef<Eigen::Vector3d> v)
{
    Eigen::Matrix3d m;
    m << 0, -v(2), v(1), //
        v(2), 0, -v(0),  //
...
IPC_TOOLKIT_HOST_DEVICE inline VectorMax3d point_line_normal(
    Eigen::ConstRef<VectorMax3d> p,
    Eigen::ConstRef<VectorMax3d> e0,
    Eigen::ConstRef<VectorMax3d> e1)
{
...
IPC_TOOLKIT_HOST_DEVICE inline MatrixMax<double, 3, 9>
...
IPC_TOOLKIT_HOST_DEVICE inline Eigen::Vector3d triangle_unnormalized_normal(
...
IPC_TOOLKIT_HOST_DEVICE inline Eigen::Vector3d triangle_normal(
    Eigen::ConstRef<Eigen::Vector3d> a,
    Eigen::ConstRef<Eigen::Vector3d> b,
    Eigen::ConstRef<Eigen::Vector3d> c)
{
...
IPC_TOOLKIT_HOST_DEVICE inline Eigen::Matrix<double, 3, 9>
...
IPC_TOOLKIT_HOST_DEVICE inline Eigen::Vector3d line_line_unnormalized_normal(
...
IPC_TOOLKIT_HOST_DEVICE inline Eigen::Vector3d line_line_normal(
    Eigen::ConstRef<Eigen::Vector3d> ea0,
    Eigen::ConstRef<Eigen::Vector3d> ea1,
    Eigen::ConstRef<Eigen::Vector3d> eb0,
    Eigen::ConstRef<Eigen::Vector3d> eb1)
...
IPC_TOOLKIT_HOST_DEVICE inline Eigen::Matrix<double, 3, 12>
