    ...
    T p0_x, T p0_y, T p0_z, T p1_x, T p1_y, T p1_z, T J[36])
{
    ...
    const T t14 = T(1) / ipc::numext::sqrt(t9);
    ...
    const T t30 = T(1) / ipc::numext::sqrt(t29);
    const T t31 = t15 * t4;
    const T t32 = T(1) / t29;
    ...
    const T t48 = T(1) / ipc::numext::sqrt(t47);
    const T t49 = T(1) / t47;
    const T t50 = t0 * t45;
    ...
    T J[54])
{
    ...
    const T t26 = T(1) / ipc::numext::sqrt(t25);
    const T t27 = -t5;
    const T t28 = -t1;
    ...
    const T t35 = T(1) / ipc::numext::sqrt(t22);
    const T t36 = -e0_y;
    const T t37 = T(1) / t22;
    const T t38 = t37 * t8;
    ...
    const T t53 = T(1) / ipc::numext::sqrt(t52);
    const T t54 = T(1) / t52;
    ...
    T J[72])
{
    ...
    const T t6 = t3 + t5;
    const T t7 = t1 + t6;
    const T t8 = T(1) / ipc::numext::sqrt(t7);
    const T t9 = T(1) / t7;
    const T t10 = t3 * t9 - 1;
    ...
    const T t50 = T(1) / ipc::numext::sqrt(t49);
    const T t51 = t27 * t29;
    const T t52 = -t51;
    const T t53 = T(1) / t49;
    const T t54 = 2 * t19;
    ...
    const T t64 = T(1) / ipc::numext::sqrt(t63);
    const T t65 = 2 * t34;
    const T t66 = t36 + t65;
    const T t67 = T(1) / t63;
    const T t68 = t42 * t67;
    ...
    T J[72])
{
    ...
    const T t51 = T(1) / ipc::numext::sqrt(t50);
    ...
    const T t68 = T(1) / ipc::numext::sqrt(t67);
    const T t69 = t18 * t2;
    const T t70 = t22 * t4;
    const T t71 = -t70;
    const T t72 = T(1) / t67;
