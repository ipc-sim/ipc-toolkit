    ...
    const EdgeEdgeDistanceType dtype) const
{
    ...
    return edge_edge_distance(
        positions.row(edges(edge0_id, 0)), positions.row(edges(edge0_id, 1)),
        positions.row(edges(edge1_id, 0)), positions.row(edges(edge1_id, 1)),
        dtype);
}
    ...
    const double conservative_rescaling) const
{
    return edge_edge_ccd(
        // Edge 1 at t=0
        positions_t0.row(edges(edge0_id, 0)),
        positions_t0.row(edges(edge0_id, 1)),
        // Edge 2 at t=0
        positions_t0.row(edges(edge1_id, 0)),
        positions_t0.row(edges(edge1_id, 1)),
        // Edge 1 at t=1
        positions_t1.row(edges(edge0_id, 0)),
        positions_t1.row(edges(edge0_id, 1)),
        // Edge 2 at t=1
        positions_t1.row(edges(edge1_id, 0)),
        positions_t1.row(edges(edge1_id, 1)), //
...
{
    std::cout << positions_t0.row(edges(edge0_id, 0)).format(OBJ_VERTEX_FORMAT);
    std::cout << positions_t0.row(edges(edge0_id, 1)).format(OBJ_VERTEX_FORMAT);
    std::cout << positions_t0.row(edges(edge1_id, 0)).format(OBJ_VERTEX_FORMAT);
    std::cout << positions_t0.row(edges(edge1_id, 1)).format(OBJ_VERTEX_FORMAT);
    std::cout << positions_t1.row(edges(edge0_id, 0)).format(OBJ_VERTEX_FORMAT);
    std::cout << positions_t1.row(edges(edge0_id, 1)).format(OBJ_VERTEX_FORMAT);
    std::cout << positions_t1.row(edges(edge1_id, 0)).format(OBJ_VERTEX_FORMAT);
    std::cout << positions_t1.row(edges(edge1_id, 1)).format(OBJ_VERTEX_FORMAT);
    std::cout << std::flush;
}
