...
protected:
    ...
    /// @param positions Positions of the vertices (rowwise)
...
public:
    ...
    enum class DiffWRT {
        ...
        Ut,        ///< Differentiate wrt previous positions.
        velocities ///< Differentiate wrt velocities.
    };
...
protected:
    ...
    /// @param positions Vertex positions for the constraint's vertices (stacked into a vector).
