    ...
    } else if (mesh.dim() == 3) {
        {
            ...
            auto loop_body = [&](const tbb::blocked_range<index_t>& r) {
                ...
                for (index_t f = r.begin(); f < r.end(); f++) {
                    ...
                    // high-order quadrature, since that includes verts
            ...
            logger().debug("[HighOrderContactPotential] face quadrature points
                    ...
                    for (index_t le = 0; le < 3; le++) {
                        ...
                        for (index_t other_edge_id :
                            ...
                            if (auto iter =
                                ...
                                const HighOrderCollisionDict<PointType::EDGE>&
                                    dict = *(iter->second);
