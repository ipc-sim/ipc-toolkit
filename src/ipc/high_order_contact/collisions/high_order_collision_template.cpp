...
T eval_ev3d_energy_ad(
    Eigen::ConstRef<
        ipc::VectorMax<double, ipc::HighOrderCollision::ELEMENT_SIZE>>
        positions,
...
template <>
HighOrderCollisionType
HighOrderCollisionTemplate<Vertex3, Vertex3>::type() const
{
    return HighOrderCollisionType::VERTEX_VERTEX;
}
template <>
HighOrderCollisionType
HighOrderCollisionTemplate<Edge3P1, Vertex3>::type() const
{
    return HighOrderCollisionType::EDGE_VERTEX;
}
template <>
HighOrderCollisionType
HighOrderCollisionTemplate<Face3P1, Vertex3>::type() const
{
    return HighOrderCollisionType::FACE_VERTEX;
}
template <>
HighOrderCollisionType
HighOrderCollisionTemplate<Vertex2, Vertex2>::type() const
{
    return HighOrderCollisionType::VERTEX_VERTEX;
}
template <>
HighOrderCollisionType
HighOrderCollisionTemplate<Vertex2, Edge2P1>::type() const
{
    return HighOrderCollisionType::EDGE_VERTEX;
}
...
template <>
std::string HighOrderCollisionTemplate<Vertex3, Vertex3>::name() const
{
    return "vv_3d";
}
template <>
std::string HighOrderCollisionTemplate<Edge3P1, Vertex3>::name() const
{
    return "ev_3d";
}
template <>
std::string HighOrderCollisionTemplate<Face3P1, Vertex3>::name() const
{
    return "fv_3d";
}
template <>
std::string HighOrderCollisionTemplate<Vertex2, Vertex2>::name() const
{
    return "vv_2d_pt";
}
template <>
std::string HighOrderCollisionTemplate<Vertex2, Edge2P1>::name() const
{
    return "ev_2d_pt";
}
...
template <typename PrimitiveA, typename PrimitiveB>
index_t
HighOrderCollisionTemplate<PrimitiveA, PrimitiveB>::vertex_id(index_t i) const
{
...
HighOrderCollisionTemplate<Vertex3, Vertex3>::operator_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
...
template <>
std::pair<double, double>
HighOrderCollisionTemplate<Edge3P1, Vertex3>::operator_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
    const AdaptiveSupport* adaptive,
    const NearFarBarrier* nf_barrier) const
...
template <>
std::pair<double, double>
HighOrderCollisionTemplate<Face3P1, Vertex3>::operator_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
    const AdaptiveSupport* adaptive,
    const NearFarBarrier* nf_barrier) const
...
template <>
std::pair<
    VectorMax<double, HighOrderCollision::ELEMENT_SIZE>,
    VectorMax<double, HighOrderCollision::ELEMENT_SIZE>>
HighOrderCollisionTemplate<Vertex3, Vertex3>::gradient_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
    const AdaptiveSupport* adaptive,
    const NearFarBarrier* nf_barrier) const
...
std::pair<
    VectorMax<double, HighOrderCollision::ELEMENT_SIZE>,
    VectorMax<double, HighOrderCollision::ELEMENT_SIZE>>
HighOrderCollisionTemplate<Edge3P1, Vertex3>::gradient_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
    const AdaptiveSupport* adaptive,
    const NearFarBarrier* nf_barrier) const
{
    ...
    VectorMax<double, HighOrderCollision::ELEMENT_SIZE> result_near(9),
        result_far(9);
...
std::pair<
    VectorMax<double, HighOrderCollision::ELEMENT_SIZE>,
    VectorMax<double, HighOrderCollision::ELEMENT_SIZE>>
HighOrderCollisionTemplate<Face3P1, Vertex3>::gradient_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
    const AdaptiveSupport* adaptive,
    const NearFarBarrier* nf_barrier) const
{
    ...
    VectorMax<double, HighOrderCollision::ELEMENT_SIZE> result_near(12),
        result_far(12);
...
std::pair<
    ...
    MatrixMax<
        ...
        HighOrderCollision::ELEMENT_SIZE,
        HighOrderCollision::ELEMENT_SIZE>>
HighOrderCollisionTemplate<Vertex3, Vertex3>::hessian_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
    const AdaptiveSupport* adaptive,
    const NearFarBarrier* nf_barrier) const
{
    ...
    MatrixMax<
        double, HighOrderCollision::ELEMENT_SIZE,
        HighOrderCollision::ELEMENT_SIZE>
...
std::pair<
    ...
    MatrixMax<
        ...
        HighOrderCollision::ELEMENT_SIZE,
        HighOrderCollision::ELEMENT_SIZE>>
HighOrderCollisionTemplate<Edge3P1, Vertex3>::hessian_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
    const AdaptiveSupport* adaptive,
    const NearFarBarrier* nf_barrier) const
...
std::pair<
    ...
    MatrixMax<
        ...
        HighOrderCollision::ELEMENT_SIZE,
        HighOrderCollision::ELEMENT_SIZE>>
HighOrderCollisionTemplate<Face3P1, Vertex3>::hessian_nearfar(
    Eigen::ConstRef<VectorMax<double, ELEMENT_SIZE>> positions,
    const HighOrderContactParameters& params,
    const AdaptiveSupport* adaptive,
    const NearFarBarrier* nf_barrier) const
