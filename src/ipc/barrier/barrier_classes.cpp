// Out-of-line definitions for the Barrier class hierarchy. These are host-only
// (virtual dispatch) and always compiled, unlike the free functions in
// barrier.cpp which are textually included into barrier.hpp under CUDA.
#include "barrier.hpp"
